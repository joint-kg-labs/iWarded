 ...
 * 
 * For more details about iWarded, please consult the wiki: https://github.com/joint-kg-labs/iWarded/wiki.		//<------- UPDATE WITH GITHUB LINK
 * 
 * @author tbaldazzi
 * 
...
public final class IWardedGenerator {
	...
	private void presentParameters() {
		...
		System.out.println("\nRefer to https://github.com/joint-kg-labs/iWarded/wiki for full documentation\n");				//<------- UPDATE WITH GITHUB LINK
	}
